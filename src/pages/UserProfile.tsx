...
const PRIORITY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  High:   { bg: 'rgba(225,29,72,0.08)', text: '#E11D48', border: 'rgba(225,29,72,0.25)' },
  Medium: { bg: 'rgba(13,148,136,0.08)', text: '#0D9488',  border: 'rgba(13,148,136,0.25)' },
  Low:    { bg: 'rgba(13,148,136,0.06)', text: '#0D9488', border: 'rgba(13,148,136,0.2)' },
}
      ...
      <div className="flex flex-col items-center pt-8 pb-6 px-5">
        <div className="relative mb-4">
          ...
          <div
            ...
            style={{ border: '3px solid rgba(13,148,136,0.4)', boxShadow: '0 0 28px rgba(13,148,136,0.15)' }}
          >
            <img
              src={alexPhotos[0]}
              alt="Alex"
          ...
          <button
            ...
            style={{ background: '#0D9488', border: '2px solid #FFFFFF' }}
          >
            <Edit2 size={13} style={{ color: 'white' }} />
          </button>
        </div>

        <h2 className="text-gray-900 font-bold text-2xl">{currentUser.name}, {currentUser.age}</h2>
      ...
      <div className="px-5 flex flex-col gap-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <p className="text-gray-900 font-semibold text-sm">Your Photos</p>
              ...
              <div key={i} className="relative rounded-xl overflow-hidden" style={{ width: 100, height: 120 }}>
                ...
                {i === 0 && (
                  <div
                    ...
                    style={{ background: 'rgba(13,148,136,0.9)', fontSize: 9 }}
                  >
                    Main
                  </div>
                )}
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-gray-900 font-semibold text-sm">Instagram</p>
        ...
        <div
          className="rounded-2xl p-4 flex items-center gap-4"
          style={{
            background: fbConnected ? 'rgba(24,119,242,0.08)' : 'rgba(0,0,0,0.03)',
            border: fbConnected ? '1px solid rgba(24,119,242,0.35)' : '1px solid rgba(0,0,0,0.08)',
          }}
        >
          ...
          <div className="flex-1">
            <p className="text-gray-900 font-semibold text-sm">Facebook</p>
            <p className="text-brand-textSub text-xs mt-0.5">
        ...
        <div
          className="rounded-2xl p-4 flex items-center gap-4"
          style={{
            background: xConnected ? 'rgba(0,0,0,0.05)' : 'rgba(0,0,0,0.03)',
            border: xConnected ? '1px solid rgba(0,0,0,0.15)' : '1px solid rgba(0,0,0,0.08)',
          }}
        >
          <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: 'rgba(0,0,0,0.08)' }}>
            <XIcon size={18} />
          </div>
          <div className="flex-1">
            <p className="text-gray-900 font-semibold text-sm">X (Twitter)</p>
            <p className="text-brand-textSub text-xs mt-0.5">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <p className="text-gray-900 font-semibold text-sm">Cupid's Suggestions</p>
            ...
            {CUPID_TIPS.map((tip, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-gray-900 text-sm leading-relaxed">{tip.tip}</p>
                </motion.div>
              )
            })}
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <p className="font-semibold text-sm" style={{ color: '#0D9488' }}>Profile Strength</p>
            <p className="font-bold text-sm" style={{ color: '#0D9488' }}>72%</p>
          </div>
          <ProfileBar value={72} />
        ...
        >
          {[
            ...
            <button
              key={row.label}
              className="w-full flex items-center justify-between px-4 py-3.5 text-left hover:bg-black/5 transition-colors"
              style={{ borderBottom: i < 3 ? '1px solid rgba(0,0,0,0.06)' : 'none' }}
              onClick={() => i === 3 && navigate('/upgrade')}
            >
              <div>
                <p className="text-gray-900 text-sm font-medium">{row.label}</p>
        ...
        {fromOnboarding && (
          ...
          >
            <p className="text-gray-900 font-semibold text-sm">Onboarding complete</p>
