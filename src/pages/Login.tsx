...
export default function Login() {
  ...
  return (
    ...
    >
      <button onClick={() => navigate('/')} className="mb-8 text-gray-900 w-fit">
        <ChevronLeft size={24} />
      </button>
      ...
      <div className="glass rounded-2xl p-6 flex flex-col gap-5">
        <div>
          ...
          <h1 className="text-gray-900 font-bold text-2xl">Sign in to Coupld</h1>
        </div>
          ...
          {SOCIAL_BUTTONS.map(btn => {
            ...
            return (
              <button
                ...
                style={{ background: btn.bg, border: `1px solid ${btn.border}`, color: '#111827' }}
              >
        ...
        <div className="flex flex-col gap-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl px-4 py-3 text-gray-900 text-sm outline-none"
        ...
        <button
          ...
          className="w-full py-4 rounded-xl font-bold text-white flex items-center justify-center gap-2 transition-opacity hover:opacity-90 active:scale-[0.98] disabled:opacity-60"
