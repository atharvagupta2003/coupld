  ...
  if (type === 'journey') {
    return (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path d="M18 4 L21.5 13.5 H32 L23.5 19.5 L27 29 L18 23 L9 29 L12.5 19.5 L4 13.5 H14.5 Z" fill="#D4A843" opacity="0.15" />
        <path d="M18 4 L21.5 13.5 H32 L23.5 19.5 L27 29 L18 23 L9 29 L12.5 19.5 L4 13.5 H14.5 Z" stroke="#D4A843" strokeWidth="1.5" strokeLinejoin="round" />
        <circle cx="18" cy="18" r="4" fill="#D4A843" />
      </svg>
    )
  }
  if (type === 'coach') {
    return (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        ...
        <circle cx="23" cy="14" r="6" stroke="#D4A843" strokeWidth="1.5" fill="rgba(212,168,67,0.12)" />
        {/* Connection bridge */}
        <path d="M17.5 17.5 L18.5 17.5" stroke="#D4A843" strokeWidth="2" strokeLinecap="round" />
        {/* Heart between them */}
  ...
  if (type === 'profile') {
    return (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        ...
        <path d="M22 27 L25 30 L31 23" stroke="#D4A843" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
  // default star
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      <polygon points="18,3 21.9,13.6 33,13.6 24,20.4 27.3,31 18,24.6 8.7,31 12,20.4 3,13.6 14.1,13.6"
        stroke="#D4A843" strokeWidth="1.5" strokeLinejoin="round" fill="rgba(212,168,67,0.12)" />
      <polygon points="18,9 20.5,16.4 28.3,16.4 22,20.8 24.3,28.2 18,24 11.7,28.2 14,20.8 7.7,16.4 15.5,16.4"
        fill="#D4A843" opacity="0.25" />
    </svg>
  )
}
      ...
      {show && (
        ...
        >
          <motion.div
            ...
            style={{
              background: 'linear-gradient(145deg, #2D1B4E 0%, #1C0B3A 100%)',
              border: '1px solid rgba(212,168,67,0.35)',
              boxShadow: '0 0 60px rgba(212,168,67,0.18), 0 20px 40px rgba(0,0,0,0.55)',
              maxWidth: 320,
              width: '100%',
            }}
          ...
          >
            ...
            <div className="relative flex items-center justify-center">
              {[0, 1, 2].map((i) => (
                <motion.div
                  ...
                  style={{ border: `1px solid rgba(212,168,67,${0.35 - i * 0.1})` }}
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(212,168,67,0.2) 0%, rgba(45,27,78,0.8) 100%)',
            ...
            <div className="text-center">
              ...
              <h2 className="text-white font-bold text-xl leading-tight mb-2">{title}</h2>
              <p className="text-brand-textSub text-sm leading-relaxed">{subtitle}</p>
            </div>
            ...
            <p className="text-brand-textSub/40" style={{ fontSize: 11 }}>
